...
/**
 * 약도 설정
 * TODO: 실제 약도 이미지에 맞춰 좌표 조정 필요
 */
export const FLOOR_PLAN_CONFIG: FloorPlanConfig = {
  viewBox: "0 0 800 600",  // SVG 뷰포트 크기 (실제 약도에 맞게 조정 필요)
  grid: {
    columns: 4,            // 4열 그리드 (예시)
    rows: 3,               // 3행 그리드 (예시)
    gap: 20,               // 공간 간 간격 (픽셀)
  ...
  spaces: [
    ...
    // 3호 (4인실)
    {
      ...
      name: '3호',
      displayName: '3호',
      coordinates: { x: 420, y: 20, width: 180, height: 130 },
      capacity: 4,
    },
    // 4호 (4인실)
    {
      ...
      name: '4호',
      displayName: '4호',
      coordinates: { x: 620, y: 20, width: 180, height: 130 },
      capacity: 4,
    },
    // 5호 (4인실)
    {
    ...
    // 6호 (2인실)
    {
      ...
      name: '6호',
      displayName: '6호',
      coordinates: { x: 220, y: 170, width: 180, height: 130 },
      capacity: 2,
    },
    // 7호 (4인실)
    {
      ...
      name: '7호',
      displayName: '7호',
      coordinates: { x: 420, y: 170, width: 180, height: 130 },
      capacity: 4,
    },
    // 8호 (4인실)
    {
      ...
      name: '8호',
      displayName: '8호',
      coordinates: { x: 620, y: 170, width: 180, height: 130 },
      capacity: 4,
    },
    // 9호 (4인실)
    {
      ...
      name: '9호',
      displayName: '9호',
      coordinates: { x: 20, y: 320, width: 180, height: 130 },
      capacity: 4,
    },
    // 10호 (2인실)
    {
      ...
      name: '10호',
      displayName: '10호',
      coordinates: { x: 220, y: 320, width: 180, height: 130 },
      capacity: 2,
    },
  ],
};
