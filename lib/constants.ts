...
export const GUIDE_DATA: { categories: string[]; items: GuideItem[] } = {
  ...
  items: [
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          number: 3,
          title: '연결 완료',
          description: '비밀번호 없이 바로 연결됩니다.',
        },
      ],
      faq: [
        {
          id: 'faq-1',
          question: 'WiFi가 연결이 안 돼요.',
          answer: 'WiFi 설정을 새로고침하거나, 기기를 재시작해보세요. 여전히 안 되면 관리자에게 연락해주세요.',
        },
      ],
    ...
    },
    {
      ...
      category: '규칙',
      title: '주차 안내',
      overview: '객실과 가까운 주차장에 편하게 주차해주세요. 여러 대 주차 가능합니다.',
      content: '객실과 가까운 주차장에 편하게 주차해주세요. 여러 대 주차 가능합니다.',
      images: [],
      warning: false,
      faq: [
        {
          ...
          answer: '객실 근처 주차장에 편하게 주차하시면 됩니다.',
        },
        {
          id: 'faq-2',
          question: '여러 대 주차 가능한가요?',
          answer: '네, 여러 대 주차 가능합니다.',
        },
      ],
      tags: ['주차', '규칙', '차량'],
      priority: 2,
