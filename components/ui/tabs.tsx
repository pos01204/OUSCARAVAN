...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-xl bg-background-muted p-1 text-brand-dark-muted",
      className
    )}
    {...props}
  />
