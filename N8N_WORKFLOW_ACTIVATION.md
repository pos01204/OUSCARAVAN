...
**방법 1: 워크플로우 편집기에서 활성화**

1. **n8n 워크플로우 편집기** 상단 확인
2. **"Active" 토글** 찾기 (워크플로우 제목 옆)
3. **토글을 ON으로 변경** (초록색으로 변경)
4. 워크플로우가 활성화됨
...
3. 워크플로우 카드에서 **"Active" 토글** 클릭
4. 토글이 초록색으로 변경되면 활성화됨
...
**활성화된 워크플로우 표시:**
- 워크플로우 카드에 **초록색 "Active" 배지** 표시
- 워크플로우 편집기 상단에 **"Active" 토글이 ON** 상태

**비활성화된 워크플로우 표시:**
- 워크플로우 카드에 **회색 "Inactive" 배지** 표시
- 워크플로우 편집기 상단에 **"Active" 토글이 OFF** 상태
