...
import { GuestHelpContent } from '@/components/guest/GuestHelpContent';
...
export default async function GuestHelpPage({
  ...
  try {
    ...
    return <RetryablePageError title="도움말을 불러오지 못했어요" description={message} />;
  }
  ...
  return (
    ...
    >
      <GuestHelpContent token={params.token} />
    </Suspense>
  );
}
